...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./jack.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jackTEAM/Files_jack/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevjackW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevjackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
jack_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
jack_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
jack_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
jack_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function Sourcejack(msg,data) -- بداية العمل
if msg then
...
if DevjackW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,jack_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevjackW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevjackW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevjackW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevjackW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevjackW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevjackW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevjackW(msg) then 
...
if text == 'تحديث السورس ❃' and DevjackW(msg) then 
os.execute('rm -rf jack.lua')
os.execute('wget https://raw.githubusercontent.com/jackTEAM/jack/master/jack.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بويكا\n ❃∫ الاصدار » { 1.3v}')
dofile('jack.lua')  
end
if text == 'الاصدار ❃' and DevjackW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بويكا \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevjackW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/BO6OK) \n ❃∫ [قناه السورس](t.me/BO6OK)')
end
if text == "ضع اسم للبوت ❃" and DevjackW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevjackW(msg) then 
...
if text == 'المشتركين ❃' and DevjackW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevjackW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevjackW(msg) then
...
if text == ("قائمه العام ❃") and DevjackW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevjackW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevjackW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevjackW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevjackW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevjackW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevjackW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevjackW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevjackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevjackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..jackk..''..jack..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevjackW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevjackW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevjackW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevjackW(msg) then
...
local jack1_Msg = database:get(bot_id.."jack1:Add:Filter:Rp2"..text..msg.chat_id_)   
if jack1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if jack_Msg and not Special(msg) then  
local jack_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if jack_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevjackW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevjackW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevjackW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevjackW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevjackW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevjackW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevjackW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevjackW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevjackW(msg) then  
...
database:sadd(bot_id.."jack:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."jack:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_jack = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_jack then 
names_jack = database:smembers(bot_id.."jack:blocname"..msg.chat_id_) or ""
if names_jack and names_jack[1] then 
for i=1,#names_jack do 
if name_jack:match("(.*)("..names_jack[i]..")(.*)") then 
...
function amir_jacka_new(jack1,jack2)
...
local jackChengName = database:get(bot_id.."jack:Cheng:Name"..data.id_)
if not data.first_name_ then 
if jackChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..jackChengName..']')
database:del(bot_id.."jack:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if jackChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."jack:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local jackChengUserName = database:get(bot_id.."jack:Cheng:UserName"..data.id_)
if not data.username_ then 
if jackChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..jackChengUserName..']')
database:del(bot_id.."jack:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if jackChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."jack:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if jackChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."jack:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if jackChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."jack:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevjackW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevjackW(msg) then    
dofile('jack.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevjackW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevjackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevjackW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevjackW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevjackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevjackW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevjackW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevjackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevjackW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevjackW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevjackW(msg) then
...
if text == 'الملفات' and DevjackW(msg) then
...
if DevjackW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jackTEAM/Files_jack/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevjackW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jackTEAM/Files_jack/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevjackW(msg) then
...
if text == "مسح الملفات" and DevjackW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevjackW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevjackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_jack, nil)
return false 
end
...
database:set(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."jack1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."jack1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."jack1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."jack1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."jack1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."jack1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."jack1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."jack1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."jack1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."jack1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."jack1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do  
local jack_Msg = database:get(bot_id.."jack1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..jack_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevjackW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevjackW(msg) then
...
if text == 'تفعيل الاذاعه' and DevjackW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevjackW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..jack_Msg[math.random(#jack_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevjackW(msg) then 
...
if text == ("مسح ردود المطور") and DevjackW(msg) then 
...
if text == ("ردود المطور") and DevjackW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevjackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevjackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevjackW(msg) then   
...
if text == 'تعطيل المغادره' and DevjackW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'jack')..') '
...
-- vardump(data) 
jackdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevjackW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/jack.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/jack.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/jack.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
jack = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(jack)
...
------------------------------------------------------------------------
local jackAbot = database:get(bot_id.."jack1:Add:Filter:Rp2"..text..result.chat_id_)   
if jackAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..jackAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local jack1_Msg = database:get(bot_id.."jack1:Add:Filter:Rp2"..text..result.chat_id_)   
if jack1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..jack1_Msg)
