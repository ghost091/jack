...
send(msg.chat_id_,msg.id_, '[كفايه كدب بقي 😹👻.](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💘](t.me/uu_wega)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[خت قلبي 🥺🙈](t.me/uu_wega)') 
return false
end
if text == 'باي' then 
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[باي ي حته مني 🥺💘](t.me/uu_wega)') 
return false
end
