...
Text = "  ↬ .Jack TEAM \n\n ↬ . [Channel](t.me/Source_JACK)\n\n ↬ . [DEVELOPER](t.me/xx_shico)\n\n↬ . [DEVELOPER](t.me/Oo_Tiger)\n\n↬ . [TWS ](t.me/ww_shico_Bot)"
keyboard = {}
keyboard.inline_keyboard = {
{{text = 'قناه السورس.',url="t.me/Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/osso1000/53&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'شيكو' or text == 'شيكو مياتي' or text == 'شيكو الهكر' or text == 'شيكو ع نفسو' then
Text = "[مبرمج السورس](t.me/xx_shico) "
keyboard = {}
keyboard.inline_keyboard = {
...
if text == 'تيجر' or text == 'تيجر مياتي' or text == 'تايجر' or text == 'تايجر ع نفسو' then
Text = "[مطور السورس](t.me/Oo_Tiger) "
keyboard = {}
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Source_Queen/1305&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
return false
  ...
  {
  {text = '𝐁𝐎𝐘𝐊𝐀 {𝐑} 𝐓𝐄𝐀𝐌', url="t.me/Source_JACK"},
  },
  }
local msg_id = msg.id_/2097152/0.5
